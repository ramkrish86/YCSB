...
public class JdbcDBClient extends DB implements JdbcDBClientConstants {
  ...
  @Override
	...
	@Override
	public int update(String tableName, String key, HashMap<String, ByteIterator> values, int keynum) {
	  if (tableName == null) {
      return -1;
    }
    if (key == null) {
	...
	@Override
	public int insert(String tableName, String key, HashMap<String, ByteIterator> values, int keynum) {
	  if (tableName == null) {
	    return -1;
	  }
	  if (key == null) {
